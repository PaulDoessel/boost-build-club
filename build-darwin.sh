...
./b2   -j16 --build-dir=build-OSX     --stagedir=stage-OSX   --toolset=clang cxxflags="-std=c++11 -stdlib=libc++ -arch i386 -arch x86_64" linkflags="-stdlib=libc++" link=static threading=multi stage
